...
// GPPG version 1.5.2
// Machine:  MacBook-Pro
// DateTime: 6/2/2018 4:59:50 PM
// UserName: fedemengo
// Input file <gppg/grammar.y - 6/2/2018 4:59:10 PM>
...
namespace FFC.FParser {
	...
	#line 35 "gppg/grammar.y"
							{ CurrentSemanticValue = ValueStack[ValueStack.Depth-2]; }
	#line default
			break;
		case 3: // dec_list -> declaration
	#line 38 "gppg/grammar.y"
							{ CurrentSemanticValue = new DeclarationStatementList(ValueStack[ValueStack.Depth-1]); }
	#line default
			break;
		case 4: // dec_list -> dec_list, declaration
	#line 39 "gppg/grammar.y"
	...
	#line 42 "gppg/grammar.y"
												{ CurrentSemanticValue = new DeclarationStatement(new Identifier(ValueStack[ValueStack.Depth-5].values[0]), ValueStack[ValueStack.Depth-4], ValueStack[ValueStack.Depth-2]); }
	#line default
			break;
		case 6: // opt_type -> /* empty */
	#line 45 "gppg/grammar.y"
							{ CurrentSemanticValue = null; }
	#line default
			break;
		case 7: // opt_type -> COLON, type
	#line 46 "gppg/grammar.y"
					{ CurrentSemanticValue = ValueStack[ValueStack.Depth-2]; }
	#line default
			break;
		case 8: // type -> INTEGER
	#line 49 "gppg/grammar.y"
					{ CurrentSemanticValue = new IntegerType(); }
	#line default
			break;
		case 9: // type -> COMPLEX
	#line 50 "gppg/grammar.y"
				{ CurrentSemanticValue = new ComplexType(); }
	#line default
			break;
		case 10: // type -> RATIONAL
	#line 51 "gppg/grammar.y"
				{ CurrentSemanticValue = new RationalType(); }
	#line default
			break;
		case 11: // type -> REAL
	#line 52 "gppg/grammar.y"
				{ CurrentSemanticValue = new RealType(); }
	#line default
			break;
		case 12: // type -> STRING
	#line 53 "gppg/grammar.y"
				{ CurrentSemanticValue = new StringType(); }
	#line default
			break;
		case 13: // type -> BOOLEAN
	#line 54 "gppg/grammar.y"
				{ CurrentSemanticValue = new BooleanType(); }
	#line default
			break;
		case 14: // type -> func_type
	#line 55 "gppg/grammar.y"
					{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
	#line default
			break;
		case 15: // type -> tuple_type
	#line 56 "gppg/grammar.y"
					{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
	#line default
			break;
		case 16: // type -> array_type
	#line 57 "gppg/grammar.y"
					{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
	#line default
			break;
		case 17: // type -> map_type
	#line 58 "gppg/grammar.y"
				{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
	#line default
			break;
		case 18: // expr -> secondary
	#line 61 "gppg/grammar.y"
							{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
	#line default
			break;
		case 19: // expr -> secondary, LESS, expr
	#line 62 "gppg/grammar.y"
	...
	#line 159 "gppg/grammar.y"
									{ CurrentSemanticValue = null; }
	#line default
			break;
		case 80: // loop_header -> FOR, ID, IN, expr
	#line 160 "gppg/grammar.y"
